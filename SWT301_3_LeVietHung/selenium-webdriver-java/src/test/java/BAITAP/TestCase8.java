...
public class TestCase8 {
    ...
    public static void test07() throws InterruptedException {
        ...
        WebElement myOrderButton = driver.findElement(By.xpath("/html/body/div[1]/div/div[2]/div/div[1]/div/div[2]/ul/li[4]/a"));
        myOrderButton.click();

        WebElement Account = driver.findElement(By.xpath("/html/body/div[1]/div/header/div/div[2]/div/a"));
        Account.click();

        WebElement myAccountLink = driver.findElement(By.xpath("/html/body/div[1]/div/header/div/div[5]/div/ul/li[1]/a"));
        myAccountLink.click();
        ...
        String fileName = "E:\\SWT301\\selenium-webdriver-java\\src\\test\\java\\Picture\\verifyOrder.png";
        try {
